...
TEST(casillasAtacadasTEST, atacadasDelActualAlfilYTorre) {
    tablero t = {
    ...
    vector<coordenada> esperado = {
            make_pair(6,2), make_pair(5,2), make_pair(4,2), make_pair(3,2), make_pair(2,2), make_pair(7,0), make_pair(7,1), make_pair(7,3), make_pair(7,4), make_pair(7,5), make_pair(7,6), make_pair(7, 7), //Torre Blanca en (7,2)
            make_pair(7,2), make_pair(3,6), make_pair(2,7), make_pair(1,2), make_pair(2,3), make_pair(3,4), make_pair(5,6), make_pair(6,7), //Alfil Blanco en (4,5)
            make_pair(6,3), make_pair(5,3), make_pair(5,4), make_pair(5,5), make_pair(6,5) //Rey Blanco en (6,4)
